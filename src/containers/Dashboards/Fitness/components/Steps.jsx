...
class Steps extends PureComponent {
    ...
    render() {
        const data = [{ value: this.props.ratio_rank , fill: '#4ce1b6' }, { value: this.DiffResult(this.props.ratio_rank), fill: '#eeeeee' }];
        return (
            <CardBody className="dashboard__health-chart-card">
                ...
                <div className="dashboard__health-chart">
                    ...
                    <div className="dashboard__health-chart-info">
                        <p className="dashboard__health-chart-number">{ this.props.ratio_rank }</p>
                        <p className="dashboard__health-chart-units">{ this.props.ratio_rank } /100</p>
                    </div>
                </div>
