...
class SocialScore extends PureComponent {
  ...
  render() {
    return (
      <div className="dashboard__weekly-stat-social-score-item">
        <div className="dashboard__weekly-stat-social-score-title">
          {this.props.children}
        </div>
        <div className="dashboard__weekly-stat-social-score-progress">
...
const WeeklyStat = ({ t }) => (
  ...
  >
    <div className="dashboard__weekly-stat">
      ...
      <div className="dashboard__weekly-stat-social-score">
