...
const wrappedRoutes = () => (
  <div>
    ...
    <div className="container__wrap">
      <Route exact path="/keyworddomains" component={TopKeywordIndex} />
      <Route exact path="/keyworddomains/:keyword" component={KeywordDomains} />
      <Route exact path="/campain/:web" component={CampainDetails} />
      <Route exact path="/campain" component={Campain} />
      <Route exact path="/linkprofile" component={LinkProfile} />
      <Route exact path="/linkprofile/:domain" component={LinkProfileDetails} />
      <Route exact path="/serp_comparison/:keyword" component={SerpComparison} />
      <Route exact path="/serp_comparison/:keyword/:date" component={SerpComparisonDate} />
      <Route exact path="/crawl" component={Crawl} />
      <Route exact path="/crawl/:domain" component={CrawlDetails} />
      <Route exact path="/suggest/:keyword" component={SerpSuggest} />
      <Route exact path="/suggest" component={Suggest} />
      <Route exact path="/serp_analyse" component={SerpAnalyse} />
      <Route exact path="/serp_analyse/:domain" component={SerpAnalyseDetails} />
      <Route exact path="/serp/:keyword" component={SerpDetails} />
      <Route exact path="/serp/:keyword/:date" component={SerpDateDetails} />
      <Route exact path="/serp" component={SerpIndex} />
